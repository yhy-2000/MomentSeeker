...
class LlavaNextProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[LlavaNextProcessorKwargs],
        ...
        # text_inputs = self.tokenizer(prompt_strings, **output_kwargs["text_kwargs"],padding="max_length", truncation=True, max_length=128)
        # print(output_kwargs["text_kwargs"])
        text_inputs = self.tokenizer(prompt_strings, padding=True, truncation=True, max_length=128, padding_side='right',return_tensors='pt')
