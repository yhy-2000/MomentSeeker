...
def main(args):
    ...
    # )
    save_dir = f"/share/liangzy/CoVR_code/embedv2"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_dir", type=Path, default="/share/junjie/shuyan/video_traindata/liwei_youtube_videos/videos/youtube_video_2024")
    # /share/huaying/long_video/video_retriever/benchmark/retrieval/webvid/eval_tv2v.jsonl
    parser.add_argument("--todo_ids", type=str, default="/share/huaying/long_video/video_retriever/benchmark/retrieval/webvid/eval_tv2v.jsonl")
    # parser.add_argument("--todo_ids", type=str, default="/share/huaying/long_video/video_retriever/benchmark/retrieval/corpus_level_tv2v_youtube/eval_tv2v.jsonl")
